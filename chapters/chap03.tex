...
More details on the training loop are mentioned and shown in the relevant section here \ref{subsection:training_loop} - briefly however the steps in the training loop are:
