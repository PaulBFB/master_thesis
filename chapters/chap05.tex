...
Elaboration on this is found in the final chapter, it just seems prudent to note here that the axiom that comes to mind is:
...
By recording these split points, decision trees effectively learn how to halve the data until all resulting observations are in pure subsets (or alternatively a maximum number of splits or a minimum number of samples has been reached). 
